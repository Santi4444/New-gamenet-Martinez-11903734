...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    void Start()
    {
        ...
        //loads the scene the master client is in and the players sync to that scene
    ...
    //When a property of a player changes like the ready or the checkmark
    ...
    //When the master client leaves someone else becomes master client
